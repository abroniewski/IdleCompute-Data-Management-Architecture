...
After cloning the project, run main.py. This will use the data provided in[](https://) data/raw and run through the full data pipeline from landing zone, formatted zone and exploitation.
